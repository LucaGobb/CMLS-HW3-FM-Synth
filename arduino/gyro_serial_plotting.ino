...
void loop() {
  ...
  pitch = -(atan2(normAccel.XAxis, sqrt(normAccel.YAxis * normAccel.YAxis + normAccel.ZAxis * normAccel.ZAxis)) * 180.0) / M_PI + 90;
  roll = (atan2(normAccel.YAxis, normAccel.ZAxis) * 180.0) / M_PI + 90;
